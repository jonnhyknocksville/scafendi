...
<main class="content container-fluid px-0">
    ...
    <?php
        ...
        require_once __DIR__ . '/sections/06-reviews.php';
        require_once __DIR__ . '/sections/07-partners.php';
        require_once __DIR__ . '/sections/08-values.php';
        require_once __DIR__ . '/sections/09-clients.php';
    ?>
